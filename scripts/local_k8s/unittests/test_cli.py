...
def test_local_k8s_make_targets_smoke_successful_flow(
    ...
    env = os.environ.copy()
    # A host BASH_ENV can rewrite PATH when Make starts its recipe shell. The
    # same PATH is also passed as a Make override because the Makefile normally
    # prepends user tool directories ahead of the inherited value.
