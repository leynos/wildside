...
the CNPG Cluster CRD for PostgreSQL. It integrates with the `vault_eso` module
...
2. **cert_manager module** — optional TLS for PostgreSQL connections.
