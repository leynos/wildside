...
active navigation, degraded GPS, narrative snippet fallback, saved routes, and
share dialogs.
...
- [ ] Persist notes, progress, route plans, and narrative snippets.
- [ ] Verify generated-walk and map flows.
