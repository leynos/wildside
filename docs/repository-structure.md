...
│
├─ security/                          # dependency audit policy and helpers
│  ├─ audit-exceptions.json           # time-bound audit exceptions
│  ├─ audit-exceptions.schema.json    # JSON Schema for the allowlist
│  ├─ audit-exception-policy.js       # exception date validation
│  ├─ audit-package-data.js           # package tree and advisory normalization
│  ├─ audit-reporting.js              # advisory partitioning and stderr output
│  ├─ audit-utils.js                  # PNPM audit orchestration and re-exports
│  ├─ constants.js                    # shared audit constants
│  ├─ validate-audit.js               # repository audit-policy validator
│  └─ validator-patch.js              # audit schema validator patching
│
├─ deploy/
│  ├─ docker/                         # Dockerfiles
│  │  ├─ backend.Dockerfile
