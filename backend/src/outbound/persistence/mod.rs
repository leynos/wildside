...
mod diesel_user_interests_command;
mod diesel_user_preferences_repository;
mod diesel_user_profile_query;
...
pub use diesel_user_interests_command::DieselUserInterestsCommand;
pub use diesel_user_preferences_repository::DieselUserPreferencesRepository;
pub use diesel_user_profile_query::DieselUserProfileQuery;
